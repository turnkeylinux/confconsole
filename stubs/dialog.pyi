# dialog.pyi --- typing for dialog.py
# -*- coding: utf-8 -*-
#
# Copyright (C) 2022 TurnKey GNU/Linux
#
...
class error(Exception):
    ...
    def complete_message(self: Any) -> str:
        ...


def _dash_escape(args: list[str]) -> list[str]:
    ...


def _dash_escape_nf(args: list[str]) -> list[str]:
    ...


def _simple_option(option, enable) -> tuple[str]:
    ...
